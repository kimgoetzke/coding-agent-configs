...
- **If no** → continue with Step 2.
  - Examples: "analyse this RFC", "summarise the compliance requirements", "investigate options for a new library", "compare approaches for X"
...
- Store output in `{repo root}/.ai/planning/{existing plan folder}/{yyyy-mm-dd} {task-name}.md`
- Example: `.ai/planning/2026-04-09 refactor-auth-flow/2026-04-10 auth-middleware-analysis.md`

**Standalone (no existing plan):**

- Store output at: `{repo root}/.ai/research/{yyyy-mm-dd} {task-name}.md`
